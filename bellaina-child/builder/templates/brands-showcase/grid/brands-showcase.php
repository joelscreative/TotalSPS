...
<?php if ( ! empty( $children ) ) : ?>
	...
	<div<?php echo $wrapper_atts; ?>>
		<?php echo $this->html( esc_html( $super_title ), '<h2 class="tm_pb_brands_showcase_module__super-title">%s</h3>' ); ?>
		<?php echo $this->html( esc_html( $title ), '<h3 class="tm_pb_brands_showcase_module__title">%s</h2>' ); ?>
